...
import { useScheduleCreationParams } from './use-schedule-creation-params';

/** Компонент параметров создания выписки. */
export const ScheduleCreationParams: React.FC = () => {
  const { change, batch } = useForm();
  const [options] = useScheduleCreationParams();
...
ScheduleCreationParams.displayName = 'ScheduleCreationParams';
